...
const fileWatcherPluginConfig = wpThemeUserConfig && wpThemeUserConfig.fileWatcherPlugin
...
module.exports = function (webpackEnv) {
    ...
    const publicPathWithTrailingSlash = isEnvProduction
        ? wpThemeUserConfig.homepage.endsWith("/") ? wpThemeUserConfig.homepage : `${wpThemeUserConfig.homepage}/`
        : paths.servedPath;
    // wptheme added - end
                ...
                },
                {
                    ...
                    oneOf: [
                        ...
                        // that fall through the other loaders.
                        {
                            ...
                            exclude: [/\.(js|mjs|jsx|ts|tsx)$/, /\.html$/, /\.json$/, /\.php$/,],
                            options: {
                                name: 'static/media/[name].[hash:8].[ext]',
                            },
                        },
